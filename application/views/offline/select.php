    ...
    <div class="col-xs-10 main" id="main">
        ...
        <div>
            <h3>5月18日 星期日</h3>
            <p><a class="btn btn-primary" href="<?=site_url('offline_question/questionare/1')?>" target="_blank">第一套</a></p>
            <p><a class="btn btn-primary" href="<?=site_url('offline_question/questionare/2')?>" target="_blank">第二套</a></p>
            <p><a class="btn btn-primary" href="<?=site_url('offline_question/questionare/3')?>" target="_blank">第三套</a></p>
        </div>
